...
import { Book, Clock, User, LogOut, Activity } from "lucide-react";
import Link from "next/link";
import { Button } from "@/components/ui/button";
import Image from "next/image";

export const metadata = {
  title: "Student Dashboard - Sona IT Library",
};
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="container mx-auto px-4 py-8">
           ...
           <Card className="col-span-1 md:col-span-4 bg-white border-0 shadow-sm">
             <CardContent className="p-6 flex flex-col md:flex-row justify-between items-start md:items-center">
                ...
                <div className="mt-4 md:mt-0 flex gap-4 text-sm font-medium">
                   ...
                   <div className="bg-slate-100 px-3 py-1.5 rounded-md text-slate-700">{user.course} - Year {user.year}</div>
                </div>
             </CardContent>
           </Card>
            ...
            <Card className="shadow-sm border-slate-200">
              ...
              <CardContent>
                <p className="text-3xl font-bold text-slate-900">{stats.avgDurationMinutes} <span className="text-sm font-normal text-slate-500">mins</span></p>
              </CardContent>
            </Card>
            ...
            <Card className={`col-span-1 md:col-span-4 shadow-sm border-slate-200 ${currentVisit ? 'bg-blue-50 border-blue-200' : ''}`}>
              <CardHeader className="pb-2">
        ...
        <h3 className="text-xl font-bold text-slate-900 mb-4">Recent Visits</h3>
        <Card className="shadow-sm border-slate-200">
